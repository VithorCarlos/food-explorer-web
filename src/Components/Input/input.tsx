...
const InputForwardRef: React.ForwardRefRenderFunction<
  HTMLInputElement,
  InputInputProps
> = ({ isValid, hasError, errorMessage, className, ...props }, ref) => {
  return (
    <>
      <input
        ref={ref}
        className={twMerge(
          "h-full w-full overflow-hidden bg-transparent px-3.5 py-3.5 placeholder:text-light_500 focus:outline-1 focus:outline-dark_950",
